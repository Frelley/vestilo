...
Preserve the actual clothing item and mannequin as faithfully as possible: same color, print, logo/text, fabric texture, wrinkles, seams, stitching, shape, neckline, sleeves, proportions, pose, and crop.
Preserve all printed artwork and text exactly as seen, even if imperfect or slightly blurry. Do not invent, replace, correct, sharpen, or rewrite logo text.
...
Do not iron, redraw, over-smooth, upscale, stylize, repaint, or reinterpret the product.
